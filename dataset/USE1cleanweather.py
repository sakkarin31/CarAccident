# -*- coding: utf-8 -*-
"""
Clean & Normalize Songkhla Weather Data (2020–2024)
---------------------------------------------------
- Parse date/time → 30-minute grid
- Fill missing numeric values (rolling + interpolate)
- Map condition to {Clear, Rain, Mist}
- Handle outliers (clip + replace 0 with median)
- Save final cleaned files per year
"""
